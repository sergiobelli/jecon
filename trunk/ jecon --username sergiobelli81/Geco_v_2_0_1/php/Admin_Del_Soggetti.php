...
include("clublib.inc");
checkAdmin();
$message = "Sei sicuro di voler rimuovere il soggetto?";
if (isset($actionflag) && $actionflag=="Delete") {
    //$result = delRow($subject_table, "ID_Soggetto", $ID_Soggetto);
    $result = connetti_query("update sd_soggetti set Deleted='Y' where ID_Soggetto=".$ID_Soggetto);
