...
$message = "";
	...
	if (isset($actionflag))
		...
		if (isset ($form['ID_Cliente']) && !($form['ID_Cliente'] == ""))
			...
			header("Location: Admin_Composizione_Nota.php");
			exit;
			}
		}
...
<head>
	...
	<title>Nuova Nota di Credito</title>
...
<div align="center"><font class="FacetFormHeaderFont">Nuova Nota di Credito</font></div>
