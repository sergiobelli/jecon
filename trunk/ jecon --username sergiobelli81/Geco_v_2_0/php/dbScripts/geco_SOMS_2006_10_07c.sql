...
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("66", "23", "2006-05-30", "Contanti", "20.00", "0.00", "2", "Scuola Allievi Lezione Febbraio 2006", "0", "0000-00-00", "N", "0");
...
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("76", "63", "2006-01-01", "Contanti", "753.73", "0.00", "2", "Sado Cassa a passaggio consegne", "0", "0000-00-00", "N", "0");
...
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("110", "81", "2006-07-22", "Contanti", "100.00", "0.00", "2", "                            Oblazione Giustina Vanda in memoria di Giustina Florindo              ", "1", "2006-07-22", "N", "sergio.belli");
...
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("124", "65", "2006-09-06", "Contanti", "0.00", "430.00", "2", "Compenso Luglio/Agosto 2006 Platini Fabrizio", "2", "2006-09-06", "N", "sergio.belli");
...
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("138", "103", "2006-10-06", "Contanti", "0.00", "41.62", "2", "                            Rimborso a Marisa.\r\nchi è?\r\nper cosa?                        ", "1", "2006-10-06", "N", "sergio.belli");
...
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("143", "103", "2006-01-18", "Contanti", "0.00", "4.50", "2", "Racc. Ministero", "1", "2006-01-18", "N", "sergio.belli");
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("144", "103", "2006-02-04", "Contanti", "0.00", "230.00", "2", "Sottovoce", "1", "2006-02-04", "N", "sergio.belli");
...
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("147", "115", "2006-02-13", "Contanti", "0.00", "55.00", "2", "                                                        Acquisto cancelleria presso Isola che non c\'è.                                                ", "12", "2006-02-13", "N", "sergio.belli");
...
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("153", "56", "2006-01-31", "Contanti", "20.00", "0.00", "2", "                                                        Oblazione Mancin                        Gabriele                        ", "18", "2006-01-31", "N", "sergio.belli");
...
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("176", "83", "2006-07-12", "Contanti", "0.00", "95.20", "2", "Imposta Comunale sulla Pubblicità", "14", "2006-07-12", "N", "sergio.belli");
...
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("183", "83", "2006-06-14", "Bonifico Bancario", "1500.00", "0.00", "3", "                                                    Bonifico ricevuto da \"Comuine di Grignasco\" a favore di Musica Società Operaia \"del 12/06/2006\" mandato 784 - Compenso banda soms per servizi 2005", "19", "2006-06-13", "N", "sergio.belli");
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("184", "131", "2006-06-14", "Bonifico Bancario", "807.00", "0.00", "3", "Servizio Prato Sesia.\r\n              Bonifico ricevuto da comune di prato sesia a favore di musica società operaia \r\n                                      ", "22", "2006-06-08", "N", "sergio.belli");
INSERT INTO `sd_movimenti` (`ID_Movimento`, `ID_Soggetto`, `Data_Valuta`, `Tipo_Pagamento`, `Entrate`, `Uscite`, `ID_Banca`, `Descrizione`, `Id_Voce_Bilancio`, `Data_Competenza`, `Deleted`, `ID_Admin`) VALUES("185", "132", "2006-05-20", "Bonifico Bancario", "796.05", "0.00", "3", "              Servizio Novara Primo Maggio.\r\nBonifico ricevuto da comune di novara                                       ", "22", "2006-05-01", "N", "sergio.belli");
...
INSERT INTO `sd_soggetti` (`ID_Soggetto`, `Ragione_Sociale`, `Cognome`, `Nome`, `PI`, `CF`, `Descrizione`, `Tipo`, `Indirizzo`, `Citta`, `CAP`, `Provincia`, `Telefono`, `Telefono2`, `Telefono3`, `Fax`, `Cell`, `E_mail`, `Password`, `Web`, `Deleted`, `Privacy`) VALUES("11", "", "Famiglia", "DaParé", NULL, NULL, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "N", "Y");
...
INSERT INTO `sd_soggetti` (`ID_Soggetto`, `Ragione_Sociale`, `Cognome`, `Nome`, `PI`, `CF`, `Descrizione`, `Tipo`, `Indirizzo`, `Citta`, `CAP`, `Provincia`, `Telefono`, `Telefono2`, `Telefono3`, `Fax`, `Cell`, `E_mail`, `Password`, `Web`, `Deleted`, `Privacy`) VALUES("14", "", "Vinzio Rag.", "Laura", NULL, NULL, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "N", "Y");
...
INSERT INTO `sd_soggetti` (`ID_Soggetto`, `Ragione_Sociale`, `Cognome`, `Nome`, `PI`, `CF`, `Descrizione`, `Tipo`, `Indirizzo`, `Citta`, `CAP`, `Provincia`, `Telefono`, `Telefono2`, `Telefono3`, `Fax`, `Cell`, `E_mail`, `Password`, `Web`, `Deleted`, `Privacy`) VALUES("89", "", ".", "Domenico", "", "", NULL, NULL, "", "", "", "", "", "", "", "", "", "", "", "", "N", "Y");
...
INSERT INTO `sd_soggetti` (`ID_Soggetto`, `Ragione_Sociale`, `Cognome`, `Nome`, `PI`, `CF`, `Descrizione`, `Tipo`, `Indirizzo`, `Citta`, `CAP`, `Provincia`, `Telefono`, `Telefono2`, `Telefono3`, `Fax`, `Cell`, `E_mail`, `Password`, `Web`, `Deleted`, `Privacy`) VALUES("98", "", ".", "Wilmo", "", "", NULL, NULL, "", "", "", "", "", "", "", "", "", "", "", "", "N", "Y");
...
INSERT INTO `sd_soggetti` (`ID_Soggetto`, `Ragione_Sociale`, `Cognome`, `Nome`, `PI`, `CF`, `Descrizione`, `Tipo`, `Indirizzo`, `Citta`, `CAP`, `Provincia`, `Telefono`, `Telefono2`, `Telefono3`, `Fax`, `Cell`, `E_mail`, `Password`, `Web`, `Deleted`, `Privacy`) VALUES("102", "clarinetto invorio", ".", ".", "", "", NULL, NULL, "", "", "", "", "", "", "", "", "", "", "", "", "N", "Y");
...
INSERT INTO `sd_soggetti` (`ID_Soggetto`, `Ragione_Sociale`, `Cognome`, `Nome`, `PI`, `CF`, `Descrizione`, `Tipo`, `Indirizzo`, `Citta`, `CAP`, `Provincia`, `Telefono`, `Telefono2`, `Telefono3`, `Fax`, `Cell`, `E_mail`, `Password`, `Web`, `Deleted`, `Privacy`) VALUES("115", "Isola che non c\'è", ".", ".", "", "", NULL, NULL, "", "", "", "", "", "", "", "", "", "", "", "", "N", "Y");
