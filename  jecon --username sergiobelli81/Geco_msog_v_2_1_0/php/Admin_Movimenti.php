...
<table align="center" >
   ...
   <tr>
    ...
    -->
    <tr>
        <td align="left" nowrap class="FacetDataTD"><b>Anno Bilancio</b></td>
        <td colspan="2" align="left" nowrap class="FacetDataTD"><b>Date</b></td>
        <td nowrap class="FacetDataTD">&nbsp;</td>
        <td nowrap class="FacetDataTD">
            <b>Soggetto/Descrizione</b>
        </td>
        <td nowrap class="FacetDataTD">&nbsp;</td>
        <td nowrap class="FacetDataTD">
            <b>Voce Bilancio</b>
...
<table border="0" cellpadding="3" cellspacing="1" class="FacetFormTABLE" align="center">
    ...
    <?php
        if ($orderby == "2 DESC") { $orderby = " ID_Movimento Desc "; }
		$query = 
		...
		if (isset($searchByAnnoBilancio)) {
            $query .= " WHERE  sd_movimenti.Anno_Bilancio = '".$annoRichiesto."' 
                               and (sd_movimenti.Id_Voce_Bilancio = sd_voci_bilancio.id OR sd_movimenti.Id_Voce_Bilancio = 0)
                               and sd_movimenti.Deleted = 'N'
