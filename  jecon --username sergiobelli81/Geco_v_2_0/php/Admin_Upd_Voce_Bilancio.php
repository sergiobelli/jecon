...
if (isset($Insert)) {
	...
	if ($message == "") {
        ...
        //echo "\n voce = ".$voce;
        //echo "\n bilancio = ".$bilancio;
        VoceBilancioManager::modifica($id, $voce, $bilancio);
...
<html>
    ...
    <head><title>Aggiorna Voce di Bilancio</title></head>
    ...
    <body>
        ...
        <form method="post" action="<?php print $PHP_SELF;?>" >
            ...
            <table border="0" cellpadding="3" cellspacing="1" class="FacetFormTABLE" align="center">
                ...
                <tr><td colspan="2" align="right" nowrap class="FacetFooterTD"><input name="Insert" type="submit" value="Update" class="FacetButton"></td></tr>
