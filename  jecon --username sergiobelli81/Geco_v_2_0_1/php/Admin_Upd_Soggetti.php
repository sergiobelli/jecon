...
/*                
	...
	$cliente = getRow($customers_table, "ID_Cliente", $ID_Soggetto);
...
*/	
	if ( $message == "") // nessun errore	
		{
		$result = subjectUpdate($ID_Soggetto, $form["Ragione_Sociale"], $form["Cognome"], $form["Nome"], $form["PI"], $form["CF"], $form["Indirizzo"], $form["Citta"], $form["CAP"], $form["Provincia"], $form["Telefono"], $form["Telefono2"], $form["Telefono3"], $form["Fax"], $form["Cell"], $form["Password"], $form["Web"], $form["E_mail"]);
		$message = "Dati Aggiornati!";
		}
	}		
$form = getRow ( $subject_table, "ID_Soggetto", $ID_Soggetto);
...
<input type="Hidden" name="ID_Soggetto" value="<?php print $ID_Soggetto?>">
<div align="center"><font class="FacetFormHeaderFont">Dati Soggetto</font></div>
